...
func newConstantInfo(tag uint8,cp ConstantPool) ConstantInfo  {
	...
	case CONSTANT_Fieldref: return &ConstantFieldrefInfo{ConstantMemberrefInfo{cp}}
	case CONSTANT_Methodref: return &ConstantMethodrefInfo{ConstantMemberrefInfo{cp}}
	case CONSTANT_InterfaceMethodref: return &ConstantInterfaceMethodrefInfo{ConstantMemberrefInfo{cp}}
